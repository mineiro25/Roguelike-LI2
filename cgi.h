...
#define QUADRADOT(X, Y, ESCALA, COR)		printf("<rect x=%d y=%d width=%d height=%d fill=%s opacity = 0 />\n", \
												ESCALA * X, ESCALA * Y, ESCALA, ESCALA, COR)
...
/*
\brief Faz um restart ao jogo
*/
#define RESTART								"http://localhost/cgi-bin/exemplo"

#define HIGHSCORE							"http://localhost/cgi-bin/exemplo?%d,%d, 100, 100"
